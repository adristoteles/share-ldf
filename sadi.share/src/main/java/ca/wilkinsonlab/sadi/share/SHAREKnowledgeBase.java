...
//		reasoningModel.close();
	...
	protected void loadFromClauses(Query query)
	{
		...
		System.out.println(String.format("WRITEIN LDF MODEL 0001000 !!!!!!!!"));
		...
		for (String sourceURI: query.getGraphURIs()) {
			try {
				...
				if (url.getFile().endsWith(".owl")) {
					...
					String rdfFormat="";
					if (url.getFile().endsWith(".owl")) rdfFormat = "RDF/XML";
					String file = url.getFile();
					if (file.endsWith(".ttl") || file.endsWith(".n3") || file.endsWith(".turtle"))
						rdfFormat = "N3";
					if (file.endsWith(".rdf") )	rdfFormat = "RDF/XML";
					
					if (rdfFormat.equals("RDF/XML") || rdfFormat.equals("N3") )
					{
					dataModel.read(sourceURI, rdfFormat);
					System.out.println("IS N3");
					dataModel.write(System.out,"RDF/XML");
					//datasetModel.addNamedModel(sourceURI, dataModel);
					RDFDataMgr.write(System.out, datasetModel, Lang.TRIG) ;
					}
					else {
						
						System.out.println("IS Linked data server !!!");
						LinkedDataFragmentGraph ldfg = new LinkedDataFragmentGraph(sourceURI);
						Model ldfgModel = ModelFactory.createModelForGraph(ldfg);
						if (ldfgModel.containsResource(ldfgModel.getResource("http://www.w3.org/ns/ldp#BasicContainer")))
						{
						...
						//	System.out.println("Resource"+ AccesorSubject.toString());
							StmtIterator i = ldfgModel.listStatements();
							while ( i.hasNext() ) {
						        ...
						        if (pre.toString().matches("http://www.w3.org/ns/ldp#contains")) {
						            ...
						            dataModel.add( obj.asResource(), dataModel.createProperty("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"),"Metarecord" );
						           // 
						        }
						    }
							dataModel.write(System.out);							
							
							ResIterator i2 = dataModel.listSubjects();
							dataModel.removeAll();
							System.out.println("after removing");
							dataModel.write(System.out);
							
							Model modelRecord =   ModelFactory.createDefaultModel();
							while ( i2.hasNext() ) 
							{
								...
								if (code!=404)	{									
									...
									modelRecord.read(sub.getURI(), rdfFormat);
								}
								...
								StmtIterator i3 = modelRecord.listStatements();
								System.out.println(modelRecord.write(System.out));
								while ( i3.hasNext() ) {
									...
									System.out.println("subjectURI ="+sub.getURI());
									System.out.println("predicaso ="+predicate.toString());
									...
									if (obj.contains(".ttl") || obj.contains(".n3") || obj.contains(".turtle"))	rdfFormat = "N3";
									else if (obj.contains(".rdf") )	rdfFormat = "RDF/XML";
									System.out.println(rdfFormat);
									...
									System.out.println(code);
									if (code!=404)	dataModel.read(obj, rdfFormat);			
									else System.out.println("ERROR 404");
									}
						...
						//	modelRecord.write(System.out);
							else { 
								System.out.println("IS a dataset !!!");
								dataModel.add(ldfgModel);
								}						
